class Solution {
    public int maxProfit(int[] prices) {
        int next[][]= new int[2][3];//0,1// handles base case prices.length+1 like if(indx==prices.length) return 0; we hold when i==prices+1;// here no need to fill so int dp[]
         int profit=0;
        ...
        return next[1][2];//recur(0,1,prices,dp);
